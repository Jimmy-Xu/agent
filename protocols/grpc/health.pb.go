...
type HealthClient interface {
	Check(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error)
	Version(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*VersionCheckResponse, error)
}
...
func (c *healthClient) Check(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
...
func (c *healthClient) Version(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*VersionCheckResponse, error) {
	out := new(VersionCheckResponse)
	err := c.cc.Invoke(ctx, "/grpc.Health/Version", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedHealthServer) Check(ctx context.Context, req *CheckRequest) (*HealthCheckResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Check not implemented")
}
func (*UnimplementedHealthServer) Version(ctx context.Context, req *CheckRequest) (*VersionCheckResponse, error) {
